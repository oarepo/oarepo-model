...
class TestDynamicObjectRoundTrip:
    """Storing arbitrary data in a dynamic-object field and reading it back must produce the original value unchanged.

    Before the fix, dump() always
    ...
    def test_field_is_raw(self, dynamic_field):
        """Dynamic-object marshmallow field must be fields.Raw, not Nested."""

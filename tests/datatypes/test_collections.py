...
DATE_RANGE_MIXIN = "tests.datatypes.test_collections.DateRangeMixin"
REQUIRED_TOGETHER_MIXIN = "tests.datatypes.test_collections.RequiredTogetherMixin"
EXTRA_FIELD_MIXIN = "tests.datatypes.test_collections.ExtraFieldMixin"
...
class TestMarshmallowSchemaMixins:
    ...
    def test_mixin_must_be_a_schema_subclass(self, datatype_registry):
        ...
        element = object_element(["tests.datatypes.test_collections.NotASchema"])
    ...
    def test_unknown_mixin_import_path_fails(self, datatype_registry):
        ...
        element = object_element(["tests.datatypes.test_collections.NoSuchMixin"])
    ...
    def test_marshmallow_schema_class_takes_precedence(self, datatype_registry):
        ...
        element = {
            **object_element([DATE_RANGE_MIXIN]),
            "marshmallow_schema_class": "tests.datatypes.test_collections.PlainSchema",
        }
        schema_cls = datatype_registry.get_type(element).create_marshmallow_schema(element)

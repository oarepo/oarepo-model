...
def _dump_marshmallow(schema: type[Schema] | Schema, generated: bool) -> None:
    """Echo a model's marshmallow schemas, optionally only the generated ones."""
...
def marshmallow(model: SimpleNamespace, generated: bool) -> None:
    ...
    _dump_marshmallow(model.RecordSchema, generated)
...
def ui_marshmallow(model: SimpleNamespace, generated: bool) -> None:
    ...
    _dump_marshmallow(model.RecordUISchema, generated)

...
from oarepo_runtime.services.config.service import SearchAllConfigMixin

from oarepo_model.customizations import ChangeBase, Customization, AddMixins
...
class RDMRecordServiceConfigPreset(Preset):
    ...
    def apply(
        ...
        yield AddMixins("RecordServiceConfig", SearchAllConfigMixin)
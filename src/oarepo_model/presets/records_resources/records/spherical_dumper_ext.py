...
def _shape_to_opensearch(value: Any) -> dict[str, Any]:
    ...
    """
    return cast("dict[str, Any]", shapely_mapping(icrs_shape_to_lon_lat(_to_geometry(value))))
...
def _shape_from_opensearch(value: Any) -> dict[str, Any]:
    ...
    """
    return cast("dict[str, Any]", shapely_mapping(lon_lat_to_icrs_shape(_to_geometry(value))))

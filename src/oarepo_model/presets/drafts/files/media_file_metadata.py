...
class MediaFileMetadataPreset(Preset):
    ...
    def apply(
        ...
        yield AddBaseClass("MediaFileMetadata", db.Model)
        yield AddBaseClass("MediaFileMetadata", RecordMetadataBase)
        yield AddBaseClass("MediaFileMetadata", FileRecordModelMixin)

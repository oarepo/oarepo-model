...
class ModelNamespace[R: Record](SimpleNamespace):
    ...
    #: files collected from BuilderFile partials, keyed "module_name/file_path";
    #: set by InvenioModelBuilder.collect_files at build time
    __files__: dict[str, FileContent]
    #: symlinks collected from BuilderSymbolicLink partials, mapping the symbolic
    #: key to the "module_name/file_path" it points at; set by
    #: InvenioModelBuilder.collect_files at build time
    __symlinks__: dict[str, str]
    Record: type[R]
